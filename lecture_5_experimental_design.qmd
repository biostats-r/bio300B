...
Example: You want to test the yield of five different types
of barley to determine what grain type is the best.

Design 1: Each grain type is planted in separate areas of
the field.

```{r}
knitr::include_graphics("figures/design-systematic-errors.png")
```

## Systematic errors

Design 2: Each grain type is randomly planted in
several squares of the field to avoid systematic
errors

```{r}
knitr::include_graphics("figures/design-randomisation.png")
```
