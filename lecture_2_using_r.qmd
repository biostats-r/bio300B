...
`&&` AND - TRUE if both TRUE `||` OR - TRUE if either TRUE `!` NOT - TRUE if FALSE (or use `!=`)
...
::: aside
[By Rob Koster - Own work, CC BY-SA 3.0](https://commons.wikimedia.org/w/index.php?curid=25230696)
:::
