...
Find the relationship of the presence-absence of _Fragilariopsis kerguelensis_ ("F. kerguelensis [%]"), perhaps the most abundant diatom in the Southern Ocean, with latitude in the data from above.
...
Find the relationship between the relative abundance of  _Fragilariopsis kerguelensis_  with latitude

- plot the data
- fit an appropriate model including a quadratic term 
